...
parameters =[
    ...
    'randomforestregressor__max_depth' : [2, 3, 5, 10],
...
ic| model.best_estimator_: Pipeline(steps=[('minmaxscaler', MinMaxScaler()),
                                           ('randomforestregressor',
                                            RandomForestRegressor(max_depth=10, min_samples_leaf=3,
                                                                  min_samples_split=8))])
ic| model.best_params_: {'randomforestregressor__max_depth': 10,
                         'randomforestregressor__min_samples_leaf': 3,
                         'randomforestregressor__min_samples_split': 8}
ic| model.best_score_: 0.8153854545599447
ic| model.score(x_test, y_test): 0.8240438727259105
정답률 :  0.8240438727259105
'''