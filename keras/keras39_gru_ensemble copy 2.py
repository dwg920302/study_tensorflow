...
from tensorflow.keras.layers import Dense, GRU, Dropout, Input, concatenate
...
dense_1_1 = GRU(8, activation='relu')(input_1)
output_1 = Dense(8, name='denseA4')(dense_1_1)

input_2 = Input(shape=(3, 1))
dense_2_1 = GRU(8, activation='relu')(input_2)
...
[array([[43.043053],
       [51.808838],
       [60.49451 ]], dtype=float32), array([[35.96317 ],
       [43.191883],
       [50.37982 ]], dtype=float32)]
'''