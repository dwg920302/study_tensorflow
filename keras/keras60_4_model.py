...
model.fit(x_train, y_train, validation_split=1/40, epochs=10)

loss, accuracy, val_loss, val_accuracy = model.evaluate(x_test, y_test)
ic(loss, accuracy, val_loss, val_accuracy)
