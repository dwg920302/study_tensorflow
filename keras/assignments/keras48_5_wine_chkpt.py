...
cp_1 = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto',
                    filepath='./_save/model_checkpoint/keras48_5_wine.hdf5')
model.compile(loss="mse", optimizer='adam', metrics=['accuracy'])
model.fit(x_train, y_train, batch_size=64, epochs=100, verbose=1, validation_split=1/12, shuffle=True, callbacks=[cp_1])
model.save('./_save/keras48_5_wine.h5')
...
'''
Epoch 100/100
53/53 [==============================] - 2s 30ms/step - loss: 0.0755 - accuracy: 0.5971 - val_loss: 0.0876 - val_accuracy: 0.5375
39/39 [==============================] - 0s 6ms/step - loss: 0.0834 - accuracy: 0.5559
loss =  0.08337530493736267
accuracy =  0.5559183955192566
'''