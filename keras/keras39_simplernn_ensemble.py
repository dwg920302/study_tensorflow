...
from tensorflow.keras.layers import Dense, SimpleRNN, Dropout, Input, concatenate
...
dense_1_1 = SimpleRNN(8, activation='relu')(input_1)
output_1 = Dense(8, name='denseA4')(dense_1_1)

input_2 = Input(shape=(3, 1))
dense_2_1 = SimpleRNN(8, activation='relu')(input_2)
...
[array([[43.570084],
       [52.102413],
       [60.634743]], dtype=float32), array([[44.57852 ],
       [53.20093 ],
       [61.823353]], dtype=float32)]
'''