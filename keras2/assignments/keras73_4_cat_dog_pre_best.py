...
# np.save('../_save/_npy/k59_x_data_cat_dog_128.npy', arr=data_x)
# np.save('../_save/_npy/k59_y_data_cat_dog_128.npy', arr=data_y)

data_x = np.load('../_save/_npy/k59_x_data_cat_dog_128.npy')
data_y = np.load('../_save/_npy/k59_y_data_cat_dog_128.npy')
...
loss =  0.6818814277648926
accuracy =  0.5388349294662476

[Condition :  Trainable   GlobalAvgPool ]
loss =  0.4796191155910492
accuracy =  0.7572815418243408

[Condition :  Non-Trainable   Flatten ]
loss =  0.07684347778558731
accuracy =  0.9708737730979919

[Condition :  Non-Trainable   GlobalAvgPool ]
loss =  0.05856069177389145
