...
for trainable in trainables:
        for loop in model_names:
                ...
                pre_model = ResNet50(weights='imagenet', include_top=False, input_shape=(32, 32, 3), classifier_activation='softmax')
                ad = ''
...
loss =  2.1658196449279785
accuracy =  0.4616999924182892

[Condition :  Trainable   GlobalAvgPool ]
loss =  2.3158860206604004
accuracy =  0.453000009059906

[Condition :  Non-Trainable   Flatten ]
loss =  4.5118207931518555
accuracy =  0.02280000038444996

[Condition :  Non-Trainable   GlobalAvgPool ]
loss =  4.51296329498291
accuracy =  0.023000000044703484
'''