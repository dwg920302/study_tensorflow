...
for trainable in trainables:
        for loop in model_names:
                ...
                pre_model = EfficientNetB0(weights='imagenet', include_top=False, input_shape=(32, 32, 3), classifier_activation='softmax')
                ad = ''
