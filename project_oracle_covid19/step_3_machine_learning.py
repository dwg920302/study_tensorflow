...
amplify_size = 2    # 이 수치를 수정하여 데이터를 얼마나 반복시킬 지 정함
...
history = model.fit([x1, x2], y, verbose=2, epochs=50, batch_size=16, validation_split=1/6, validation_batch_size=16, 
            callbacks=[es, chkpt], shuffle=True)
